...
CREATE TABLE `Autori` (
  ...
  UNIQUE KEY `idAutori_UNIQUE` (`idAutore`)
...
INSERT INTO `Autori` VALUES (1,'Alessandro Manzoni'),(2,'Luigi Pirandello'),(3,'Dan Brown'),(4,'Roberto Saviano'),(5,'Agostino Lorenzi'),(6,'Walt Disney');
