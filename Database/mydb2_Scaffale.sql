...
CREATE TABLE `Scaffale` (
  `idScaffale` int(11) NOT NULL AUTO_INCREMENT,
  `Posizione` int(11) NOT NULL,
  `LibriTotali` int(11) NOT NULL,
  PRIMARY KEY (`idScaffale`),
  UNIQUE KEY `idScaffale_UNIQUE` (`idScaffale`)
...
INSERT INTO `Scaffale` VALUES (1,1,100),(2,2,100),(3,3,100),(4,4,100);
